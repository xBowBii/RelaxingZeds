...
if (!isDedicated) then {
	...
	player_buildControls 	= compile preprocessFileLineNumbers "custom\player_buildControls.sqf";
	snap_object 		= compile preprocessFileLineNumbers "custom\snap_object.sqf";
